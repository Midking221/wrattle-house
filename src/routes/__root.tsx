...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Wattle House — Garden Restaurant in Rungiri" },
      { name: "description", content: "Wattle House is a warm garden restaurant in Rungiri, Kikuyu. Dine-in, kerbside pickup & delivery. Open daily." },
      { name: "author", content: "Wattle House" },
      { property: "og:title", content: "Wattle House — Garden Restaurant in Rungiri" },
      ...
      { name: "twitter:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/attachments/og-images/b894c2dc-feed-4692-844b-e03d06c1f2f8" },
    ],
    links: [
      {
        rel: "stylesheet",
